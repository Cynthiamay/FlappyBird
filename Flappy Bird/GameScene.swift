    ...
    class GameScene: SKScene, SKPhysicsContactDelegate {
        ...
        override func didMove(to view: SKView) {
            ...
            let novavelocidade = CGFloat(defaults.double(forKey: "chave"))
            
            self.physicsWorld.contactDelegate = self
    //      defaults.set(configuracoesDoJogo(velocidade: 5), forKey: "novavelocidade")
            configuracoesDoJogo(velocidade: novavelocidade)
        ...
        override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
            ...
            if gameOver == false{
                ...
                let novavelocidadeGameOver = CGFloat(defaults.double(forKey: "chave"))
                
                configuracoesDoJogo(velocidade: novavelocidadeGameOver)
